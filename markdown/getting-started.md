...
* Software: SketchUp 2017 to 2024 are currently supported. (We are considering adding a standalone version that works without SketchUp. SketchUp 2017 Make is free; see our <a href="faqs.html">FAQ</a> about SketchUp 2017. Sketchup 2024 requires VR Sketch 21 or later.)

Mac:

* Meta Quest 2, 3 or Pro, or Pico Neo 3.  (As of 2024, OS X and tethered VR headsets are not working well together in general.)
* SketchUp 2017 to 2024.  (Sketchup 2017-2019 are not well tested and use an experimental mode for editing components. Sketchup 2024 requires VR Sketch 21 or later.)
