...
* Download and installing from inside SketchUp.
    ...
    <img class="" src="../web/img/docs/window-drop-down-menu.png" alt="Window drop down menu">      
    3. In the search bar at the top, search for "vr sketch" or just "vr". 
    <img class="" src="../web/img/docs/warehouse.png" alt="Extension Warehouse"> 
    4. From the search results select "**VR Sketch** by *Maciej F.*". 
    <img class="" src="../web/img/docs/search.png" alt="Select 'VR Sketch'"> 
    5. Click the red "Download" button in the top right. 
    <img class="" src="../web/img/docs/found.png" alt="Click download"> 
...
* Downloading from the web and installing manually.
    ...
    <img class="" src="../web/img/docs/browser.png" alt="Click download"> 
...
<img class="" src="../web/img/docs/menu-vr.png" alt="Click 'Send to VR'"> 
...
<img class="" src="../web/img/docs/vive-oculus.png" alt="Click 'Send to VR'"> 
...
<video autoplay="autoplay" loop="loop">
  <source src="../web/img/docs/tool-choose.mp4" type="video/mp4" />
</video>
...
### Select
<video autoplay="autoplay" loop="loop">
  <source src="../web/img/docs/tool-select.mp4" type="video/mp4" />
</video>
...
<video autoplay="autoplay" loop="loop">
  <source src="../web/img/docs/tool-group.mp4" type="video/mp4" />
</video>
...
### Erase
<video autoplay="autoplay" loop="loop">
  <source src="../web/img/docs/tool-erase.mp4" type="video/mp4" />
</video>
...
### Line
<video autoplay="autoplay" loop="loop">
  <source src="../web/img/docs/tool-line.mp4" type="video/mp4" />
</video>
...
### Rectangle
<video autoplay="autoplay" loop="loop">
  <source src="../web/img/docs/tool-rectange.mp4" type="video/mp4" />
</video>
...
### Polygon
<video autoplay="autoplay" loop="loop">
  <source src="../web/img/docs/tool-polygon.mp4" type="video/mp4" />
</video>
...
### Push-Pull
<video autoplay="autoplay" loop="loop">
  <source src="../web/img/docs/tool-push.mp4" type="video/mp4" />
</video>
...
### Extrude
<video autoplay="autoplay" loop="loop">
  <source src="../web/img/docs/tool-extrude.mp4" type="video/mp4" />
</video>
...
### Offset
<video autoplay="autoplay" loop="loop">
  <source src="../web/img/docs/tool-offset.mp4" type="video/mp4" />
</video>
...
### Move
<video autoplay="autoplay" loop="loop">
  <source src="../web/img/docs/tool-move.mp4" type="video/mp4" />
</video>
...
### Rotate
<video autoplay="autoplay" loop="loop">
  <source src="../web/img/docs/tool-rotate.mp4" type="video/mp4" />
</video>
...
### Scale
<video autoplay="autoplay" loop="loop">
  <source src="../web/img/docs/tool-scale.mp4" type="video/mp4" />
</video>
...
### Section plain
The tool to cut temporarily your cut your model.
